...
function CustHeader() {
  return (
    <header className="body-font sticky mt-5 w-full border-t border-gray-100 bg-white text-gray-700 shadow-sm">
      <div className="container mx-auto flex flex-col items-start justify-between p-6 md:flex-row">
        ...
        <nav className="ml-6 flex flex-wrap items-center justify-center border-l border-gray-200 pl-6 text-base md:mr-auto">
